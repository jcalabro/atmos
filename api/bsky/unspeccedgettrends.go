...
var (
	...
	jsonKey_UnspeccedGetTrends_Output_recIdStr    = []byte("\"recIdStr\":")
...
func (s *UnspeccedGetTrends_Output) AppendJSON(buf []byte) ([]byte, error) {
	...
	if s.RecIdStr.HasVal() {
		...
		buf = append(buf, jsonKey_UnspeccedGetTrends_Output_recIdStr...)
...
var (
	...
	cborKey_UnspeccedGetTrends_Output_recIdStr    = cbor.AppendTextKey(nil, "recIdStr")
)
...
func (s *UnspeccedGetTrends_Output) AppendCBOR(buf []byte) ([]byte, error) {
	...
	if len(s.extra) > 0 {
		...
		if s.RecIdStr.HasVal() {
			buf = append(buf, cborKey_UnspeccedGetTrends_Output_recIdStr...)
