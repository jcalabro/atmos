...
// Precomputed JSON key tokens for TempAddReservedHandle_Output.
var (
	jsonKey_TempAddReservedHandle_Output_dollar_type = []byte("\"$type\":")
)

func (s *TempAddReservedHandle_Output) MarshalJSON() ([]byte, error) {
	return s.AppendJSON(make([]byte, 0, 256))
}

func (s *TempAddReservedHandle_Output) AppendJSON(buf []byte) ([]byte, error) {
	buf = append(buf, '{')
	first := true
	if s.LexiconTypeID != "" {
		if !first {
		...
		buf = append(buf, jsonKey_TempAddReservedHandle_Output_dollar_type...)
...
func (s *TempAddReservedHandle_Output) UnmarshalJSON(data []byte) error {
...
// Precomputed CBOR key tokens for TempAddReservedHandle_Output.
var (
	cborKey_TempAddReservedHandle_Output_dollar_type = cbor.AppendTextKey(nil, "$type")
)

func (s *TempAddReservedHandle_Output) MarshalCBOR() ([]byte, error) {
...
func (s *TempAddReservedHandle_Output) UnmarshalCBOR(data []byte) error {
...
var (
	jsonKey_TempAddReservedHandle_Input_dollar_type = []byte("\"$type\":")
	jsonKey_TempAddReservedHandle_Input_handle      = []byte("\"handle\":")
)

func (s *TempAddReservedHandle_Input) MarshalJSON() ([]byte, error) {
	return s.AppendJSON(make([]byte, 0, 256))
}

func (s *TempAddReservedHandle_Input) AppendJSON(buf []byte) ([]byte, error) {
	buf = append(buf, '{')
	first := true
	if s.LexiconTypeID != "" {
		if !first {
		...
		buf = append(buf, jsonKey_TempAddReservedHandle_Input_dollar_type...)
		buf = cbor.AppendJSONString(buf, s.LexiconTypeID)
		first = false
	}
	if !first {
...
func (s *TempAddReservedHandle_Input) UnmarshalJSON(data []byte) error {
	_, err := s.UnmarshalJSONAt(data, 0)
	return err
}
...
// Precomputed CBOR key tokens for TempAddReservedHandle_Input.
var (
	cborKey_TempAddReservedHandle_Input_dollar_type = cbor.AppendTextKey(nil, "$type")
	cborKey_TempAddReservedHandle_Input_handle      = cbor.AppendTextKey(nil, "handle")
)

func (s *TempAddReservedHandle_Input) MarshalCBOR() ([]byte, error) {
	return s.AppendCBOR(make([]byte, 0, 256))
}
...
func (s *TempAddReservedHandle_Input) UnmarshalCBOR(data []byte) error {
	_, err := s.UnmarshalCBORAt(data, 0)
	return err
}
...
func TempAddReservedHandle(ctx context.Context, c *xrpc.Client, input *TempAddReservedHandle_Input) (*TempAddReservedHandle_Output, error) {
	...
	return &out, c.Procedure(ctx, "com.atproto.temp.addReservedHandle", input, &out)
}
