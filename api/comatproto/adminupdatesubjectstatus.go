...
// Precomputed JSON key tokens for AdminUpdateSubjectStatus_Output.
var (
	jsonKey_AdminUpdateSubjectStatus_Output_dollar_type = []byte("\"$type\":")
	jsonKey_AdminUpdateSubjectStatus_Output_subject     = []byte("\"subject\":")
	jsonKey_AdminUpdateSubjectStatus_Output_takedown    = []byte("\"takedown\":")
)

func (s *AdminUpdateSubjectStatus_Output) MarshalJSON() ([]byte, error) {
	return s.AppendJSON(make([]byte, 0, 256))
}

func (s *AdminUpdateSubjectStatus_Output) AppendJSON(buf []byte) ([]byte, error) {
	buf = append(buf, '{')
	first := true
	if s.LexiconTypeID != "" {
		if !first {
		...
		buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Output_dollar_type...)
	...
	buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Output_subject...)
	{
		var err error
	...
	if s.Takedown.HasVal() {
		...
		buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Output_takedown...)
		{
			v := s.Takedown.Val()
			{
				var err error
...
func (s *AdminUpdateSubjectStatus_Output) UnmarshalJSON(data []byte) error {
...
// Precomputed CBOR key tokens for AdminUpdateSubjectStatus_Output.
var (
	cborKey_AdminUpdateSubjectStatus_Output_dollar_type = cbor.AppendTextKey(nil, "$type")
	cborKey_AdminUpdateSubjectStatus_Output_subject     = cbor.AppendTextKey(nil, "subject")
	cborKey_AdminUpdateSubjectStatus_Output_takedown    = cbor.AppendTextKey(nil, "takedown")
)

func (s *AdminUpdateSubjectStatus_Output) MarshalCBOR() ([]byte, error) {
...
func (s *AdminUpdateSubjectStatus_Output) AppendCBOR(buf []byte) ([]byte, error) {
	...
	if len(s.extra) > 0 {
		...
		ei, buf = appendCBORExtrasBefore(s.extra, ei, "takedown", buf)
		if s.Takedown.HasVal() {
...
// AdminUpdateSubjectStatus_Output_Subject is a union type.
...
func (u AdminUpdateSubjectStatus_Output_Subject) MarshalJSON() ([]byte, error) {
	return u.AppendJSON(make([]byte, 0, 256))
}

func (u AdminUpdateSubjectStatus_Output_Subject) AppendJSON(buf []byte) ([]byte, error) {
	...
	return nil, fmt.Errorf("cannot marshal empty union AdminUpdateSubjectStatus_Output_Subject")
}

func (u *AdminUpdateSubjectStatus_Output_Subject) UnmarshalJSON(data []byte) error {
	_, err := u.UnmarshalJSONAt(data, 0)
	return err
}

func (u *AdminUpdateSubjectStatus_Output_Subject) UnmarshalJSONAt(data []byte, pos int) (int, error) {
...
func (u AdminUpdateSubjectStatus_Output_Subject) MarshalCBOR() ([]byte, error) {
	return u.AppendCBOR(make([]byte, 0, 256))
}

func (u AdminUpdateSubjectStatus_Output_Subject) AppendCBOR(buf []byte) ([]byte, error) {
	if u.AdminDefs_RepoRef.HasVal() {
		v := *u.AdminDefs_RepoRef.Val()
		v.LexiconTypeID = "com.atproto.admin.defs#repoRef"
...
var (
	jsonKey_AdminUpdateSubjectStatus_Input_dollar_type = []byte("\"$type\":")
	jsonKey_AdminUpdateSubjectStatus_Input_deactivated = []byte("\"deactivated\":")
	jsonKey_AdminUpdateSubjectStatus_Input_subject     = []byte("\"subject\":")
	jsonKey_AdminUpdateSubjectStatus_Input_takedown    = []byte("\"takedown\":")
)

func (s *AdminUpdateSubjectStatus_Input) MarshalJSON() ([]byte, error) {
	return s.AppendJSON(make([]byte, 0, 256))
}

func (s *AdminUpdateSubjectStatus_Input) AppendJSON(buf []byte) ([]byte, error) {
	buf = append(buf, '{')
	first := true
	if s.LexiconTypeID != "" {
		if !first {
		...
		buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Input_dollar_type...)
		buf = cbor.AppendJSONString(buf, s.LexiconTypeID)
		first = false
	}
	if s.Deactivated.HasVal() {
		...
		buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Input_deactivated...)
		{
			v := s.Deactivated.Val()
			{
				var err error
	...
	buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Input_subject...)
	{
		var err error
		buf, err = s.Subject.AppendJSON(buf)
		if err != nil {
	...
	if s.Takedown.HasVal() {
		...
		buf = append(buf, jsonKey_AdminUpdateSubjectStatus_Input_takedown...)
		{
			v := s.Takedown.Val()
			{
				var err error
...
func (s *AdminUpdateSubjectStatus_Input) UnmarshalJSON(data []byte) error {
	_, err := s.UnmarshalJSONAt(data, 0)
	return err
}
...
// Precomputed CBOR key tokens for AdminUpdateSubjectStatus_Input.
var (
	cborKey_AdminUpdateSubjectStatus_Input_dollar_type = cbor.AppendTextKey(nil, "$type")
	cborKey_AdminUpdateSubjectStatus_Input_subject     = cbor.AppendTextKey(nil, "subject")
	cborKey_AdminUpdateSubjectStatus_Input_takedown    = cbor.AppendTextKey(nil, "takedown")
	cborKey_AdminUpdateSubjectStatus_Input_deactivated = cbor.AppendTextKey(nil, "deactivated")
)

func (s *AdminUpdateSubjectStatus_Input) MarshalCBOR() ([]byte, error) {
	return s.AppendCBOR(make([]byte, 0, 256))
}
...
func (s *AdminUpdateSubjectStatus_Input) AppendCBOR(buf []byte) ([]byte, error) {
	...
	if len(s.extra) > 0 {
		...
		ei, buf = appendCBORExtrasBefore(s.extra, ei, "deactivated", buf)
		if s.Deactivated.HasVal() {
...
// AdminUpdateSubjectStatus_Input_Subject is a union type.
...
func (u AdminUpdateSubjectStatus_Input_Subject) MarshalJSON() ([]byte, error) {
	return u.AppendJSON(make([]byte, 0, 256))
}

func (u AdminUpdateSubjectStatus_Input_Subject) AppendJSON(buf []byte) ([]byte, error) {
	if u.AdminDefs_RepoRef.HasVal() {
		v := *u.AdminDefs_RepoRef.Val()
		v.LexiconTypeID = "com.atproto.admin.defs#repoRef"
		return v.AppendJSON(buf)
	...
	return nil, fmt.Errorf("cannot marshal empty union AdminUpdateSubjectStatus_Input_Subject")
}

func (u *AdminUpdateSubjectStatus_Input_Subject) UnmarshalJSON(data []byte) error {
	_, err := u.UnmarshalJSONAt(data, 0)
	return err
}

func (u *AdminUpdateSubjectStatus_Input_Subject) UnmarshalJSONAt(data []byte, pos int) (int, error) {
	endPos, err := cbor.SkipJSONValue(data, pos)
	if err != nil {
		return 0, err
	}
...
func (u AdminUpdateSubjectStatus_Input_Subject) MarshalCBOR() ([]byte, error) {
	return u.AppendCBOR(make([]byte, 0, 256))
}

func (u AdminUpdateSubjectStatus_Input_Subject) AppendCBOR(buf []byte) ([]byte, error) {
	if u.AdminDefs_RepoRef.HasVal() {
		v := *u.AdminDefs_RepoRef.Val()
		v.LexiconTypeID = "com.atproto.admin.defs#repoRef"
		return v.AppendCBOR(buf)
...
func AdminUpdateSubjectStatus(ctx context.Context, c *xrpc.Client, input *AdminUpdateSubjectStatus_Input) (*AdminUpdateSubjectStatus_Output, error) {
	...
	return &out, c.Procedure(ctx, "com.atproto.admin.updateSubjectStatus", input, &out)
}
